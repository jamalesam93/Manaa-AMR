...
export function getProgressData() {
    ...
    try {
        ...
        // Ensure quizHistory is an array and categoriesPlayed is an object
        if (!Array.isArray(parsed.quizHistory)) parsed.quizHistory = []
        if (!parsed.categoriesPlayed || typeof parsed.categoriesPlayed !== 'object' || Array.isArray(parsed.categoriesPlayed)) {
